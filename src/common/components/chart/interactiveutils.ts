import { isNotDefined, isDefined } from "react-financial-charts/lib/utils";
...
let currentChartInteractingId = null;
export const setCurrentChartInteractingId = (id: string): void => {
    currentChartInteractingId = id;
};
export const isCurrentChartInteractingId = (id: string): boolean => {
    return currentChartInteractingId === id;
};