...
import {ChartManageOrder, ChartManageOrderType} from "../data/ChartManageOrder";
...
export class ChartDialog extends React.Component<Props, State> {
    ...
    constructor(props) {
        super(props);
        this.state = {
            alert: props.alert, type: 'order', operationType: OperationType.BUY, quantity: 1, order: null, stopPrice: 0
        };
    ...
    handleSave = () => {
        ...
        const cancelOrder = alert.id.startsWith("order_") ? orderAndStopMap[alert.id] : null
        const cancelStopOrder = alert.id.startsWith("stop_") ? orderAndStopMap[alert.id] : null
    ...
    render() {
        ...
        const header = alert.id.startsWith("order_") ? "Edit Order"
            : alert.id.startsWith("stop_") ? "Edit Stop" : "Edit Alert"
        ...
        return (
            <Dialog header={header}
                ...
                <div className="p-grid">
                    ...
                    <div className="p-col-3">
                        <SelectButton value={operationType}
                    ...
                    </div>
                    {
                        type === "order" ?
                            ...
                            <>
                                <div className="p-col-12">
                                    <label htmlFor="chart-dialog-alert-price">Condition Price: </label>
                                    <InputText id="chart-dialog-alert-price"
                                               type="number"
                                               step={securityInfo.secPriceStep}
                                               value={alert.yValue}
