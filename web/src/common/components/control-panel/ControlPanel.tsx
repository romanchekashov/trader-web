...
import ActiveTradeView from "./components/ActiveTradesView";
  ...
  render() {
    ...
    return (
      <div
        id="control-panel"
        className="p-grid"
        style={{ top: this.VisibleTypeViewTop[visible] }}
      >
        ...
        <div className="p-col" style={{ padding: 0 }}>
          <div className="p-grid" style={{ marginTop: 0, marginRight: 0 }}>
            <div
              className="p-col-12"
              style={{ paddingBottom: 0, paddingTop: 0, height: 90 }}
            >
              ...
              {btnSet === "strategy" ? (
                <StrategyBtn onSelectStrategy={console.log} />
              ) : null}
            </div>
