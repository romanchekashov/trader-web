...
export const SecurityShareEventView: React.FC<Props> = ({secCode}) => {
    ...
    return (
        <div className="p-grid">
            <div className="p-col-4" style={{padding: 0, height: 800, overflowY: "scroll"}}>
                {
                    events.map((shareEvent, index) => {
                        ...
                        return (
                            <div className={className}
                                ...
                                <div className="menu-item-pub">Pub: {published} by {shareEvent.newsProvider}</div>
                                <div className="menu-item-title">{shareEvent.title} ({date})</div>
                            </div>
                        )
                    })
                }
