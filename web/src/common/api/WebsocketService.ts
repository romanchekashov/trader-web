...
export enum WSEvent {
  ...
  SUBSCRIBE_TRADE_PREMISE_AND_SETUP = "SUBSCRIBE_TRADE_PREMISE_AND_SETUP",
  UNSUBSCRIBE_TRADE_PREMISE_AND_SETUP = "UNSUBSCRIBE_TRADE_PREMISE_AND_SETUP",
  ...
  CREATE_STOP_ORDERS = "CREATE_STOP_ORDERS",
  TREND = "TREND",
  STACK = "STACK",
  ALERTS = "ALERTS",
  ...
  HISTORY_CREATE_STOP_ORDERS = "HISTORY_CREATE_STOP_ORDERS",
...
export class WebsocketService {
  ...
  private constructor() {
    ...
    this.websocketSub = this.subjectWS.subscribe(null, (error: ErrorEvent) =>
  ...
  private reconnect(): void {
    this.reconnection$ = interval(this.reconnectInterval).pipe(
      takeWhile((v, index) => index < this.reconnectAttempts && !this.sock)
    );
