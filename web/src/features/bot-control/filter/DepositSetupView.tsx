    ...
    <div className="p-grid">
      <div className="p-col-1">
        <div style={{ fontWeight: 700, color: "red" }}>
          Real deposit: {realDeposit?.amount}
        </div>
      ...
      <div className="p-col-1">
        ...
        <InputText
          ...
          value={setup.amount}
          onChange={(e) => {
            setup.initAmount = parseFloat(e.target["value"]);
      ...
      <div className="p-col-1">
        ...
        <InputText
          ...
          value={stop}
          onChange={(e) => {
            const newStop = parseFloat(e.target["value"]);
            setStop(newStop);
            setup.maxRiskPerTradeInPercent = getMaxRiskPerTradeInPercent(
              newStop
            );
            onChange(setup);
          }}
      ...
      <div className="p-col-1">
        ...
        <InputText
          value={setup.maxRiskPerTradeInPercent}
          onKeyDown={(e) => {
          ...
          onChange={(e) => {
            setup.maxRiskPerTradeInPercent = parseFloat(e.target["value"]);
            setStop(getStop(setup.maxRiskPerTradeInPercent));
            onChange(setup);
          }}
          style={{ width: "80px" }}
      ...
      <div className="p-col-1">
        ...
        <InputText
          value={setup.maxRiskPerSessionInPercent}
          onKeyDown={(e) => {
            riskChangeByKeyDown(e, "maxRiskPerSessionInPercent");
            onChange(setup);
          }}
          onChange={(e) => {
            setup.maxRiskPerSessionInPercent = parseFloat(e.target["value"]);
            onChange(setup);
          }}
          style={{ width: "80px" }}
        />
      ...
      <div className="p-col-1">
        ...
        <Dropdown
          value={takeProfitNumber}
          options={takeProfitNumbers}
          onChange={(e) => {
      ...
      <div className="p-col-1">
        <div style={{ fontSize: "10px" }}>
          First Take Profit Per Trade Factor
        </div>
        <InputText
          type="number"
          min={1}
      ...
      <div className="p-col-1">
        ...
        <InputText
          value={setup.takeProfitPerTradeFactorFirst * stop}
          onKeyDown={(e) => {}}
          onChange={(e) => {}}
          style={{ width: "80px" }}
        />
      ...
      <div className="p-col-1">
        <div style={{ fontSize: "10px" }}>
          Second Take Profit Per Trade Factor
        </div>
        <InputText
          type="number"
          min={2}
      ...
      <div className="p-col-1">
        ...
        <InputText
          value={setup.takeProfitPerTradeFactorSecond * stop}
          onKeyDown={(e) => {}}
          onChange={(e) => {}}
          disabled={takeProfitNumber === 1}
          style={{ width: "80px" }}
