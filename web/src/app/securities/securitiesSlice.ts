...
const initialState: SecuritiesState = {
  ...
  selectedSecurityType: SecurityType.FUTURE,
  shares: [],
  currencies: [],
  futures: [],
};
...
export const securitiesSlice = createSlice({
  ...
  reducers: {
    ...
    selectSecurityType: (state, { payload }: PayloadAction<SecurityType>) => {
      state.selectedSecurityType = payload;
    },
  },
...
export const { setSecurityById, setSecurities, selectSecurityType } =
...
export const selectSecurities = createSelector(
  (state: RootState) => ({
    selectedSecurityType: state.securities.selectedSecurityType,
